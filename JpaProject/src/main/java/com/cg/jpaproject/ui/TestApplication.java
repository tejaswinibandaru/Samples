...
public class TestApplication {
	public static void main(String[] args) {
		 ...
		 * bd1.setBusDayId(1); bd1.setDay("sunday".toUpperCase()); days.add(bd1); BusDay
		 * bd2 = new BusDay(); bd2.setBusDayId(2); bd2.setDay("monday".toUpperCase());
		 * days.add(bd2); bus.setDays(days);
		 * 
		 ...
		 * LocalTime.parse(endTimeString, formatter);
		 * 
