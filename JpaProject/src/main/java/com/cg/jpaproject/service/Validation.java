...
import com.cg.jpaproject.exception.DateException;
import com.cg.jpaproject.exception.PassengerException;
...
public class Validation {
	...
	public void validatePassengersCount(int count) throws PassengerException {
		if(count>5) {
			throw new PassengerException("Passenger count should not be more than 5 per ticket");
		}
	}
	
	public void validateGender(Character gender) throws PassengerException {
		if(!gender.equals('F')||!gender.equals('M')) {
			throw new PassengerException("Gender should be M or F");
		}
	}
	
	public void validatePaymentMode(String paymentMode) throws PassengerException {
	...
	public void validateTravel(String busSource, String busDestination) throws BusException {
	...
	public void validateBusType(String busType) throws BusException {
	...
	public void validateBusClass(String busClass) throws BusException {
	...
	public int validateChoice(String input) throws BusException {
		// TODO Auto-generated method stub
		int choice;
	...
	public int validateAdminChoice(String input) throws BusException {
		int choice;
		if(isValidNumeric(input)) {
			choice = Integer.parseInt(input);
	...
	public int validateRunloopChoice(String input) throws BusException {
		// TODO Auto-generated method stub
		int choice;
		if(isValidNumeric(input)) {
			choice = Integer.parseInt(input);
	...
	public int validateIntegerChoice(String input) throws BusException {
		  if(!isValidNumeric(input)) 
			throw new BusException("Integer choice to be entered");
		  return Integer.parseInt(input);
		}
	public int validateDayChoice(String input) throws BusException {
		// TODO Auto-generated method stub
		int choice;
		if(isValidNumeric(input)) {
			choice = Integer.parseInt(input);
